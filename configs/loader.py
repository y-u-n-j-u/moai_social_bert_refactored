...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    'train': {
        ...
        'use_gt_goal': False,
        'use_gaussian_goal': False,
        'gaussian_goal_k': 10,
        'gaussian_goal_sigma': 1.0,
        'use_goal_sampling': False,
        'goal_k': 10,
        'goal_sigma': 1.0,
        'optimizer': {
            'name': 'adamw',
...
def _to_namespace(cfg: dict[str, Any], config_path: str, cli_dry_run: bool) -> argparse.Namespace:
    ...
    return argparse.Namespace(
        ...
        use_gaussian_goal=train['use_gaussian_goal'],
        gaussian_goal_k=train['gaussian_goal_k'],
        gaussian_goal_sigma=train['gaussian_goal_sigma'],
        use_goal_sampling=train['use_goal_sampling'],
        goal_k=train['goal_k'],
        goal_sigma=train['goal_sigma'],
        cuda=runtime['cuda'],
