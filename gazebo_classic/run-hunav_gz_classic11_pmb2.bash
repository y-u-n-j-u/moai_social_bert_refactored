...
docker run -it \
    ...
    --env="HUNAV_PEDESTRIANS_AVOID_ROBOT=${HUNAV_PEDESTRIANS_AVOID_ROBOT:-True}" \
    --env="HUNAV_USE_GAZEBO_OBSTACLES=${HUNAV_USE_GAZEBO_OBSTACLES:-True}" \
    ...
    --env="HUNAV_USE_NAVGOAL_TO_START=${HUNAV_USE_NAVGOAL_TO_START:-${HUNAV_ROBOT_SAVE_TRAINING_PKL:-False}}" \
    ...
    --env="HUNAV_ROBOT_SPUBERT_TGP_TOP_K=${HUNAV_ROBOT_SPUBERT_TGP_TOP_K:-5}" \
    --env="HUNAV_ROBOT_SPUBERT_REJECTION_STREAK_LIMIT=${HUNAV_ROBOT_SPUBERT_REJECTION_STREAK_LIMIT:-3}" \
    ...
    --env="HUNAV_ROBOT_SPUBERT_DIAGNOSTICS_PATH=${HUNAV_ROBOT_SPUBERT_DIAGNOSTICS_PATH:-}" \
    ...
    --env="HUNAV_ROBOT_TRAINING_SAMPLE_STRIDE=${HUNAV_ROBOT_TRAINING_SAMPLE_STRIDE:-4}" \
    ...
    --env="HUNAV_AUTO_GOAL_NO_PROGRESS_TIMEOUT=${HUNAV_AUTO_GOAL_NO_PROGRESS_TIMEOUT:-15.0}" \
    --env="HUNAV_AUTO_GOAL_PROGRESS_RADIUS=${HUNAV_AUTO_GOAL_PROGRESS_RADIUS:-0.15}" \
