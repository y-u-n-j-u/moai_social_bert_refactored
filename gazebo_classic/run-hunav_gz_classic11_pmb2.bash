...
case "${HUNAV_DOCKER_TTY:-true}" in
    0|false|False|FALSE|no|No|NO|off|Off|OFF)
        docker_interactive_args=(-i)
        ;;
esac

docker run "${docker_interactive_args[@]}" \
    --rm \
    --name "$container_name" \
    "${gpu_args[@]}" \
    ...
    --env="HUNAV_SCENARIO=${HUNAV_SCENARIO:-}" \
    --env="HUNAV_PMB2_NAV_PARAMS_FILE=${HUNAV_PMB2_NAV_PARAMS_FILE:-}" \
    ...
    --env="HUNAV_RVIZ_CONFIG_PATH=${HUNAV_RVIZ_CONFIG_PATH:-}" \
    --env="HUNAV_USE_EVALUATOR=${HUNAV_USE_EVALUATOR:-true}" \
    ...
    --env="HUNAV_PHYSICS_UPDATE_RATE=${HUNAV_PHYSICS_UPDATE_RATE:-500.0}" \
    --env="HUNAV_HUMAN_OBSTACLE_PUBLISH_RATE=${HUNAV_HUMAN_OBSTACLE_PUBLISH_RATE:-5.0}" \
    --env="HUNAV_HUMAN_OBSTACLE_CURRENT_RING_POINTS=${HUNAV_HUMAN_OBSTACLE_CURRENT_RING_POINTS:-6}" \
    --env="HUNAV_HUMAN_OBSTACLE_SAFETY_MARGIN=${HUNAV_HUMAN_OBSTACLE_SAFETY_MARGIN:-0.15}" \
    --env="HUNAV_HUMAN_OBSTACLE_FILL_SPACING=${HUNAV_HUMAN_OBSTACLE_FILL_SPACING:-0.20}" \
    --env="HUNAV_HUMAN_OBSTACLE_PREDICTED_RING_POINTS=${HUNAV_HUMAN_OBSTACLE_PREDICTED_RING_POINTS:-6}" \
    --env="HUNAV_HUMAN_OBSTACLE_PREDICTION_HORIZON=${HUNAV_HUMAN_OBSTACLE_PREDICTION_HORIZON:-1.2}" \
    --env="HUNAV_HUMAN_OBSTACLE_PREDICTION_STEP=${HUNAV_HUMAN_OBSTACLE_PREDICTION_STEP:-0.4}" \
    --env="HUNAV_HUMAN_AVOIDANCE_MODE=${HUNAV_HUMAN_AVOIDANCE_MODE:-}" \
    --env="HUNAV_HUMAN_YIELD_SUPERVISOR=${HUNAV_HUMAN_YIELD_SUPERVISOR:-False}" \
    --env="HUNAV_HUMAN_YIELD_SAFETY_DISTANCE=${HUNAV_HUMAN_YIELD_SAFETY_DISTANCE:-1.45}" \
    --env="HUNAV_HUMAN_YIELD_RELEASE_DISTANCE=${HUNAV_HUMAN_YIELD_RELEASE_DISTANCE:-1.60}" \
    --env="HUNAV_HUMAN_YIELD_PREDICTION_HORIZON=${HUNAV_HUMAN_YIELD_PREDICTION_HORIZON:-6.0}" \
    --env="HUNAV_HUMAN_YIELD_PREDICTION_STEP=${HUNAV_HUMAN_YIELD_PREDICTION_STEP:-0.10}" \
    ...
    --env="HUNAV_ROBOT_SPUBERT_RUNTIME_SEED=${HUNAV_ROBOT_SPUBERT_RUNTIME_SEED:-21}" \
    --env="HUNAV_ROBOT_SPUBERT_TGP_TOP_K=${HUNAV_ROBOT_SPUBERT_TGP_TOP_K:-5}" \
    --env="HUNAV_ROBOT_SPUBERT_ADAPTIVE_GUIDANCE=${HUNAV_ROBOT_SPUBERT_ADAPTIVE_GUIDANCE:-False}" \
    --env="HUNAV_ROBOT_SPUBERT_ADAPTIVE_GUIDANCE_MIN_DISTANCE=${HUNAV_ROBOT_SPUBERT_ADAPTIVE_GUIDANCE_MIN_DISTANCE:-2.0}" \
    --env="HUNAV_ROBOT_SPUBERT_ADAPTIVE_GUIDANCE_PROBE_STEP=${HUNAV_ROBOT_SPUBERT_ADAPTIVE_GUIDANCE_PROBE_STEP:-0.5}" \
